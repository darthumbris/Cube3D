...
/*   Updated: 2022/06/20 13:37:48 by shoogenb      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (is_door_tile(data->level.map_planes[(int)ray->map_pos.y][(int)ray->map_pos.x][0]))
	{
	...
	else if (is_secret_tile(data->level.map_planes[(int)ray->map_pos.y][2] \
		[(int)ray->map_pos.x]))
	{
