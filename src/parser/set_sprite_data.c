...
/*   Updated: 2022/06/20 15:05:00 by shoogenb      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
	...
	t_data *data, bool is_enemy)
{
	...
	if (!is_enemy)
	{
		...
		sprite->transp_end.x = 128 - sprite->transp_begin.x;
		sprite->transp_begin.y = 0;
		sprite->transp_end.y = 128 - data->mlx.tex.obj[sprite->kind - 1]->height - 1;
