...
static const t_icon	wall_icon_lst[] = \
	{
		{"greybrick1",0,0,"WALL001.png", 1, 4},
		{"greybrick2",0,1,"WALL002.png", 5, 8},
		{"greybrick3",0,2,"WALL003.png", 9, 12},
		{"gbrick eagle",0,3,"WALL004.png", 13, 16},
		{"gbrick flag",0,4,"WALL005.png", 17, 20},
		{"gbrick hit",0,5,"WALL006.png", 21, 24},
		{"gbrick sign",0,6,"WALL030.png", 25, 28},
		{"bluebrick1",1,0,"WALL007.png", 29, 32},
		{"bluebrick2",1,1,"WALL023.png", 33, 36},
		{"bbrick sign",1,2,"WALL032.png", 37, 40},
		{"blue line",1,4,"WALL051.png", 41, 44},
		{"blue cross",1,5,"WALL052.png", 45, 48},
		{"blue skull",1,6,"WALL053.png", 49, 52},
		{"mossybrick1",1,7,"WALL028.png", 53, 56},
		{"mossybrick2",1,8,"WALL029.png", 57, 60},
		{"wood",2,0,"WALL028.png", 61, 64},
		{"wood eagle",2,1,"WALL019.png", 65, 68},
		{"wood cross",2,2,"WALL041.png", 69, 72},
		{"wood hit",2,3,"WALL049.png", 73, 76},
		{"purple1",2,5,"WALL059.png", 77, 80},
		{"purple2",2,6,"WALL060.png", 81, 84},
		{"messybrick1",2,7,"WALL021.png", 85, 88},
		{"messybrick2",2,8,"WALL022.png", 89, 92},
		{"steel wall",3,0,"WALL024.png", 93, 96},
		{"steel sign",3,1,"WALL025.png", 97, 100},
		{"tilebrick1",3,2,"WALL040.png", 101, 104},
		{"tilebrick2",3,3,"WALL042.png", 105, 108},
		{"tile flag",3,4,"WALL041.png", 109, 112},
		{"stone1",3,5,"WALL043.png", 113, 116},
		{"stone2",3,6,"WALL044.png", 117, 120},
		{"stone3",3,7,"WALL054.png", 121, 124},
		{"whitebrick1",4,0,"WALL034.png", 125, 128},
		{"wbrick hole",4,1,"WALL035.png", 129, 132},
		{"wbrick crack",4,2,"WALL036.png", 133, 136},
		{"wbrick hit,4",4,3,"WALL037.png", 137, 140},
		{"wbrick map",4,4,"WALL038.png", 141, 144},
		{"mosiac",4,5,"WALL047.png", 145, 148},
		{"redbrick",5,0,"WALL008.png", 149, 152},
		{"rbrick eagle",5,1,"WALL009.png", 153, 156},
		{"rbrick cross",5,2,"WALL010.png", 157, 160},
		{"mixedbrick",5,3,"WALL039.png", 161, 164},
		{"wood arch",2,4,"WALL050.png", 165, 165},
		{"railing",3,8,"WALL017.png", 166, 166},
		{"prison cell",1,3,"WALL020.png", 167, 167},
		{"switch",5,4,"WALL061.png", 168, 168},
...
static const t_icon	obj_icon_lst[] = \
	{
		{"barrel gr",0,0,"WALL001.png" , 1, 1},
		{"bones1",0,1,"WALL002.png", 2, 2},
		{"bones2",0,2,"WALL003.png", 3, 3},
		{"bones3",0,3,"WALL004.png", 4, 4},
		{"bones4",0,4,"WALL005.png", 5, 5},
		{"bones5",0,5,"WALL006.png", 6, 6},
		{"bones6",0,6,"WALL030.png", 7, 7},
		{"bones7",0,7,"WALL011.png", 8, 8},
		{"bones8",1,0,"WALL012.png", 9, 9},
		{"lamp g",1,1,"WALL007.png", 10, 10},
		{"stnd lamp g",1,2,"WALL023.png", 11, 11},
		{"chandelier",1,3,"WALL032.png", 12, 12},
		{"lamp r",1,4,"WALL020.png", 13, 13},
		{"well empt",1,5,"WALL051.png", 14, 14},
		{"well water",1,6,"WALL052.png", 15, 15},
		{"well blood",1,7,"WALL053.png", 16, 16},
...
static const t_icon	item_icon_lst[] = \
	{
		{"ammo1",0,0,"WALL001.png", 50, 50},
		{"silver key",0,1,"WALL002.png", 51, 51},
		{"dog meal",0,2,"WALL003.png", 52, 52},
		{"cross",0,3,"WALL004.png", 53, 53},
		{"chalice",0,4,"WALL005.png", 54, 54},
		{"chest",0,5,"WALL006.png", 55, 55},
		{"crown",0,6,"WALL030.png", 56, 56},
		{"backpack",0,7,"WALL011.png", 57, 57},
		{"fuel",1,0,"WALL012.png", 58, 58},
		{"clip",1,1,"WALL007.png", 59, 59},
		{"launcher",1,2,"WALL023.png", 60, 60},
		{"medkit",1,3,"WALL032.png", 61, 61},
		{"mach gun",1,4,"WALL020.png", 62, 62},
		{"plasmarifle",1,5,"WALL051.png", 63, 63},
		{"rockets",1,6,"WALL052.png", 64, 64},
		{"shells",1,7,"WALL053.png", 65, 65},
		{"shotgun",2,0,"WALL028.png", 66, 66},
		{"soul",2,1,"WALL019.png", 67, 67},
		{"stimulant",2,2,"WALL041.png", 68, 68},
		{"gold key",2,3,"WALL049.png", 69, 69}
	};
